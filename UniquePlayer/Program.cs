...
namespace UniquePlayer
{
    public class Program
    {
        ...
        public Program(IFileSystem fileSystem) => _fileSystem = fileSystem;

        public Program() => _fileSystem = new FileSystem();
        ...
        public static async Task<int> Main(string[] args)
        {
            ...
            return await SynthesisPipeline.Instance
                .AddRunnabilityCheck(program.RunnabilityCheck)
        ...
        private void RunnabilityCheck(IRunnabilityState state)
        {
...
&& !filePath.EndsWith(outfitOutputFileName)
        ...
        public void RunPatch(IPatcherState<ISkyrimMod, ISkyrimModGetter> state)
        {
        ...
        public Race CopyRace(IRaceGetter oldRace, IPatcherState<ISkyrimMod, ISkyrimModGetter> state, string texturesPath, string meshesPath)
        {
        ...
        public void UpdateHeadPart(IFormLinkGetter<IHeadPartGetter> headPartItem, IMajorRecordCommonGetter race, IPatcherState<ISkyrimMod, ISkyrimModGetter> state, string texturesPath, string meshesPath)
        {
